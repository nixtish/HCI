...
public class GetNameInBackground extends AbstractGetNameTask {
  ...
  public GetNameInBackground(SignInActivity activity, String email, String scope) {
  ...
  private Intent makeCallback(String accountName) {
      ...
      intent.putExtra(SignInActivity.EXTRA_ACCOUNTNAME, accountName);
      intent.putExtra(SignInActivity.TYPE_KEY, SignInActivity.Type.BACKGROUND.name());
      return intent;
  }
